...
public class WebController {
	...
	public ResponseTestFromDbServerVO getDbServerTest(String testParam) {
		...
		Map<String, String> queryParams = new HashMap<>();
		queryParams.put("firstQueryParam", testParam);
		queryParams.put("secondQueryParam", "hooking!!");
		
		ResponseTestFromDbServerVO response = HttpUtil.get("http://localhost:9020/dbServer/test", queryParams, ResponseTestFromDbServerVO.class);
